...
public class BlueGridCustomAdapter extends BaseAdapter {
    Context context;
    String alphabets[];
    LayoutInflater inflter;
    public BlueGridCustomAdapter(Context applicationContext, String[] alphabets) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.blue_level_grid_alphepet, null); // inflate the layout
